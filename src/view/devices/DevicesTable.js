...
class DevicesTable extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [
                ...
                {id: 'digital_twin', label: 'Digital twin id', minWidth: 100},
                {id: 'edit', label: 'Actions', minWidth: 170},
    ...
    viewDeviceDetail(device) {
        ...
        this.props.navigate('/devices/' + device.id);
    }
...
export default function DevicesTableWithNavigate(props){
    const navigate = useNavigate()
    return <DevicesTable navigate={navigate}/>
}